...
const VuesaxLinearMapIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    ...
    />
    <path d='M8.56 4V17' stroke='#0F1C35' strokeWidth={1.5} strokeLinecap='round' strokeLinejoin='round' />
    <path d='M15.73 6.62V20' stroke='#0F1C35' strokeWidth={1.5} strokeLinecap='round' strokeLinejoin='round' />
  </svg>
);
