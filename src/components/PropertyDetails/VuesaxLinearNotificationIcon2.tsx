...
const VuesaxLinearNotificationIcon2 = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(VuesaxLinearNotificationIcon2);
export { Memo as VuesaxLinearNotificationIcon2 };
