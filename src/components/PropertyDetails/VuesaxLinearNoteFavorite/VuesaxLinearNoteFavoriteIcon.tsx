...
const VuesaxLinearNoteFavoriteIcon = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(VuesaxLinearNoteFavoriteIcon);
export { Memo as VuesaxLinearNoteFavoriteIcon };
