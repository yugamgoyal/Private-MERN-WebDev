...
const VuesaxLinearUserCirlceAddIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
      d='M11.46 13.73C13.0119 13.73 14.27 12.4719 14.27 10.92C14.27 9.36806 13.0119 8.10999 11.46 8.10999C9.90808 8.10999 8.65 9.36806 8.65 10.92C8.65 12.4719 9.90808 13.73 11.46 13.73Z'
      stroke='#0F1C35'
      strokeWidth={1.5}
      strokeLinecap='round'
    ...
    />
    <path
      d='M16.65 20.2C16.65 17.87 14.33 15.97 11.46 15.97C8.59 15.97 6.27 17.86 6.27 20.2'
      stroke='#0F1C35'
      strokeWidth={1.5}
      strokeLinecap='round'
      strokeLinejoin='round'
...
const Memo = memo(VuesaxLinearUserCirlceAddIcon);
export { Memo as VuesaxLinearUserCirlceAddIcon };
