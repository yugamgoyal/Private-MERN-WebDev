...
const VuesaxLinearCarIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    ...
    <path
      ...
      strokeLinejoin='round'
    />
    <path d='M4 8H3' stroke='#0F1C35' strokeWidth={1.2} strokeLinecap='round' strokeLinejoin='round' />
    <path d='M21 8H20' stroke='#0F1C35' strokeWidth={1.2} strokeLinecap='round' strokeLinejoin='round' />
    <path d='M12 3V5' stroke='#0F1C35' strokeWidth={1.2} strokeLinecap='round' strokeLinejoin='round' />
    <path d='M10.5 5H13.5' stroke='#0F1C35' strokeWidth={1.2} strokeLinecap='round' strokeLinejoin='round' />
    <path d='M6 15H9' stroke='#0F1C35' strokeWidth={1.2} strokeLinecap='round' strokeLinejoin='round' />
    <path d='M15 15H18' stroke='#0F1C35' strokeWidth={1.2} strokeLinecap='round' strokeLinejoin='round' />
  </svg>
);
