...
const VuesaxLinearFormatSquareIcon = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(VuesaxLinearFormatSquareIcon);
export { Memo as VuesaxLinearFormatSquareIcon };
